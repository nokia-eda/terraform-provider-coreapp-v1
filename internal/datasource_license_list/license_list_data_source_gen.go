...
package datasource_license_list
...
func LicenseListDataSourceSchema(ctx context.Context) schema.Schema {
						...
						"status": schema.SingleNestedAttribute{
							Attributes: map[string]schema.Attribute{
								"comment": schema.StringAttribute{
									...
									MarkdownDescription: "Any comment provided in the license.",
								},
								"expiration_date": schema.StringAttribute{
									Computed:            true,
									Description:         "Date and time the license expires.",
									MarkdownDescription: "Date and time the license expires.",
								},
								"expired": schema.BoolAttribute{
									Computed:            true,
									Description:         "Indicates if the license has expired.",
									MarkdownDescription: "Indicates if the license has expired.",
								},
								...
								"used": schema.BoolAttribute{
									...
									MarkdownDescription: "Indicates if license has been used.",
								},
								"valid": schema.BoolAttribute{
									Computed:            true,
									Description:         "Indicates if the license is valid.",
									MarkdownDescription: "Indicates if the license is valid.",
								},
							},
							...
							MarkdownDescription: "Status information for this license.",
						},
					},
...
func (t StatusType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	expiredAttribute, ok := attributes["expired"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`expired is missing from object`)

		return nil, diags
	}

	expiredVal, ok := expiredAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`expired expected to be basetypes.BoolValue, was: %T`, expiredAttribute))
	}

	issuedDateAttribute, ok := attributes["issued_date"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`issued_date is missing from object`)

		return nil, diags
	}

	issuedDateVal, ok := issuedDateAttribute.(basetypes.StringValue)
	...
	usedVal, ok := usedAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`used expected to be basetypes.BoolValue, was: %T`, usedAttribute))
	}
...
func (v StatusValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Expired.ToTerraformValue(ctx)
		...
		val, err = v.IssuedDate.ToTerraformValue(ctx)
...
func (v StatusValue) Equal(o attr.Value) bool {
	...
	if !v.Expired.Equal(other.Expired) {
		return false
	}

	if !v.IssuedDate.Equal(other.IssuedDate) {
		return false
	}
