...
func HttpProxyResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^HttpProxy$"), ""),
				},
				Default: stringdefault.StaticString("HttpProxy"),
			},
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "HttpProxyStatus defines the observed state of HttpProxy",
			},
		},
	}
}
...
func (t SpecType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	rootUrlAttribute, ok := attributes["root_url"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`root_url is missing from object`)

		return nil, diags
	}

	rootUrlVal, ok := rootUrlAttribute.(basetypes.StringValue)
...
func (v SpecValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	case attr.ValueStateKnown:
		...
		val, err = v.RootUrl.ToTerraformValue(ctx)
...
func (v SpecValue) Equal(o attr.Value) bool {
	...
	if !v.RootUrl.Equal(other.RootUrl) {
		return false
	}
