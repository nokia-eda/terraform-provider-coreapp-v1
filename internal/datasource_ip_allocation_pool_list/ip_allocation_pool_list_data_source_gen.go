...
package datasource_ip_allocation_pool_list
...
func IpAllocationPoolListDataSourceSchema(ctx context.Context) schema.Schema {
...
type IpAllocationPoolListModel struct {
