...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/datasource_workflow"
...
const read_ds_workflow = "/workflows/v1/core.eda.nokia.com/v1/namespaces/{namespace}/workflows/{name}"
