...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/datasource_role_list"
...
const read_ds_roleList = "/apps/core.eda.nokia.com/v1/namespaces/{namespace}/roles"

var (
	_ datasource.DataSource              = (*roleListDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*roleListDataSource)(nil)
)
...
func (d *roleListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	err = d.client.GetByQuery(ctx, read_ds_roleList, map[string]string{
...
func (r *roleListDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
