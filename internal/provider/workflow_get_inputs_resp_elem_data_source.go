...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/datasource_workflow_get_inputs_resp_elem"
...
const read_ds_workflowGetInputsRespElem = "/workflows/v1/core.eda.nokia.com/v1/namespaces/{namespace}/workflows/{name}/_input"
