...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/resource_workflow_definition"
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/tfutils"
)

const (
	create_rs_workflowDefinition = "/apps/core.eda.nokia.com/v1/workflowdefinitions"
	read_rs_workflowDefinition   = "/apps/core.eda.nokia.com/v1/workflowdefinitions/{name}"
	update_rs_workflowDefinition = "/apps/core.eda.nokia.com/v1/workflowdefinitions/{name}"
	delete_rs_workflowDefinition = "/apps/core.eda.nokia.com/v1/workflowdefinitions/{name}"
)

var (
	_ resource.Resource                = (*workflowDefinitionResource)(nil)
	_ resource.ResourceWithConfigure   = (*workflowDefinitionResource)(nil)
	_ resource.ResourceWithImportState = (*workflowDefinitionResource)(nil)
)
...
func (r *workflowDefinitionResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_workflow_definition.WorkflowDefinitionResourceSchema(ctx)
}

func (r *workflowDefinitionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_workflow_definition.WorkflowDefinitionModel
	...
	tflog.Info(ctx, "Create()::API request", map[string]any{
		"path": create_rs_workflowDefinition,
	...
	err = r.client.Create(ctx, create_rs_workflowDefinition, nil, reqBody, &result)
	...
	err = r.client.Get(ctx, read_rs_workflowDefinition, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_workflowDefinition,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *workflowDefinitionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	tflog.Info(ctx, "Update()::API request", map[string]any{
		"path": update_rs_workflowDefinition,
		"body": spew.Sdump(reqBody),
	})
	...
	err = r.client.Update(ctx, update_rs_workflowDefinition, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *workflowDefinitionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	tflog.Info(ctx, "Delete()::API request", map[string]any{
		"path": delete_rs_workflowDefinition,
		"data": spew.Sdump(data),
	})
	...
	err := r.client.Delete(ctx, delete_rs_workflowDefinition, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)
...
func (r *workflowDefinitionResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
