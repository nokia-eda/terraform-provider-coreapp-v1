...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/resource_http_proxy"
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/tfutils"
)

const (
	create_rs_httpProxy = "/apps/core.eda.nokia.com/v1/httpproxies"
	read_rs_httpProxy   = "/apps/core.eda.nokia.com/v1/httpproxies/{name}"
	update_rs_httpProxy = "/apps/core.eda.nokia.com/v1/httpproxies/{name}"
	delete_rs_httpProxy = "/apps/core.eda.nokia.com/v1/httpproxies/{name}"
)

var (
	_ resource.Resource                = (*httpProxyResource)(nil)
	_ resource.ResourceWithConfigure   = (*httpProxyResource)(nil)
	_ resource.ResourceWithImportState = (*httpProxyResource)(nil)
)
...
func (r *httpProxyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_httpProxy, nil, reqBody, &result)
	...
	err = r.client.Get(ctx, read_rs_httpProxy, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_httpProxy,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *httpProxyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_httpProxy, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *httpProxyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_httpProxy, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)
