...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/datasource_role"
...
const read_ds_role = "/apps/core.eda.nokia.com/v1/namespaces/{namespace}/roles/{name}"
...
func (d *roleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_role.RoleModel
	...
	err = d.client.GetByQuery(ctx, read_ds_role, map[string]string{
