...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/datasource_http_proxy"
...
const read_ds_httpProxy = "/apps/core.eda.nokia.com/v1/httpproxies/{name}"

var (
	_ datasource.DataSource              = (*httpProxyDataSource)(nil)
	_ datasource.DataSourceWithConfigure = (*httpProxyDataSource)(nil)
)
...
func (d *httpProxyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_http_proxy.HttpProxyDataSourceSchema(ctx)
}

func (d *httpProxyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_http_proxy.HttpProxyModel
	...
	err = d.client.GetByQuery(ctx, read_ds_httpProxy, map[string]string{
...
func (r *httpProxyDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
