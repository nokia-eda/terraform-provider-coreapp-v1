...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/resource_namespace"
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/tfutils"
)

const (
	create_rs_namespace = "/apps/core.eda.nokia.com/v1/namespaces"
	read_rs_namespace   = "/apps/core.eda.nokia.com/v1/namespaces/{name}"
	update_rs_namespace = "/apps/core.eda.nokia.com/v1/namespaces/{name}"
	delete_rs_namespace = "/apps/core.eda.nokia.com/v1/namespaces/{name}"
)
...
func (r *namespaceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = resource_namespace.NamespaceResourceSchema(ctx)
}

func (r *namespaceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data resource_namespace.NamespaceModel
	...
	err = r.client.Create(ctx, create_rs_namespace, nil, reqBody, &result)
	...
	err = r.client.Get(ctx, read_rs_namespace, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_namespace,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *namespaceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_namespace, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *namespaceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_namespace, map[string]string{
		"name": tfutils.StringValue(data.Metadata.Name),
	}, &result)
