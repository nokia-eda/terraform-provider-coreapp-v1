...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/eda/utils"
...
var _ provider.Provider = (*coreappProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &coreappProvider{version: ver}
	}
}

type coreappProvider struct {
	version string
}
...
func (p *coreappProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *coreappProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *coreappProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "coreapp-v1"
	resp.Version = p.version
}

func (p *coreappProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterRoleDataSource,
		NewClusterRoleListDataSource,
		NewDeviationDataSource,
		NewDeviationActionDataSource,
		NewDeviationActionListDataSource,
		NewDeviationListDataSource,
		NewEdgeInterfaceDataSource,
		NewEdgeInterfaceListDataSource,
		NewHttpProxyDataSource,
		NewHttpProxyListDataSource,
		NewIndexAllocationPoolDataSource,
		NewIndexAllocationPoolListDataSource,
		NewIpAllocationPoolDataSource,
		NewIpAllocationPoolListDataSource,
		NewIpInSubnetAllocationPoolDataSource,
		NewIpInSubnetAllocationPoolListDataSource,
		NewLicenseDataSource,
		NewLicenseListDataSource,
		NewNamespaceDataSource,
		NewNamespaceListDataSource,
		NewNodeProfileDataSource,
		NewNodeProfileListDataSource,
		NewNodeUserDataSource,
		NewNodeUserListDataSource,
		NewResourceListDataSource,
		NewRoleDataSource,
		NewRoleListDataSource,
		NewSubnetAllocationPoolDataSource,
		NewSubnetAllocationPoolListDataSource,
		NewTopoBreakoutDataSource,
		NewTopoBreakoutListDataSource,
		NewTopoLinkDataSource,
		NewTopoLinkListDataSource,
		NewTopoNodeDataSource,
		NewTopoNodeListDataSource,
		NewUdpProxyDataSource,
		NewUdpProxyListDataSource,
		NewWorkflowDataSource,
		NewWorkflowDefinitionDataSource,
		NewWorkflowDefinitionListDataSource,
		NewWorkflowGetInputsRespElemDataSource,
		NewWorkflowListDataSource,
	}
}

func (p *coreappProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterRoleResource,
		NewDeviationActionResource,
		NewEdgeInterfaceResource,
		NewHttpProxyResource,
		NewIndexAllocationPoolResource,
		NewIpAllocationPoolResource,
		NewIpInSubnetAllocationPoolResource,
		NewNamespaceResource,
		NewNodeProfileResource,
		NewNodeUserResource,
		NewRoleResource,
		NewSubnetAllocationPoolResource,
		NewTopoBreakoutResource,
		NewTopoLinkResource,
		NewTopoNodeResource,
		NewUdpProxyResource,
