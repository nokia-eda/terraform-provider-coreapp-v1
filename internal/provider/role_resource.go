...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/resource_role"
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/tfutils"
)

const (
	create_rs_role = "/apps/core.eda.nokia.com/v1/namespaces/{namespace}/roles"
	read_rs_role   = "/apps/core.eda.nokia.com/v1/namespaces/{namespace}/roles/{name}"
	update_rs_role = "/apps/core.eda.nokia.com/v1/namespaces/{namespace}/roles/{name}"
	delete_rs_role = "/apps/core.eda.nokia.com/v1/namespaces/{namespace}/roles/{name}"
)
...
func (r *roleResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_role, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_role, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
...
func (r *roleResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_role, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *roleResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_role, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
