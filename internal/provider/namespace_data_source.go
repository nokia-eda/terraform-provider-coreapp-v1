...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-coreapp/internal/datasource_namespace"
...
const read_ds_namespace = "/apps/core.eda.nokia.com/v1/namespaces/{name}"
...
func (d *namespaceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = datasource_namespace.NamespaceDataSourceSchema(ctx)
}

func (d *namespaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data datasource_namespace.NamespaceModel
	...
	err = d.client.GetByQuery(ctx, read_ds_namespace, map[string]string{
