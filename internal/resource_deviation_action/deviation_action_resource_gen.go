...
package resource_deviation_action
...
func DeviationActionResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^DeviationAction$"), ""),
				},
				Default: stringdefault.StaticString("DeviationAction"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the DeviationAction",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"result": schema.StringAttribute{
						...
						MarkdownDescription: "The result of the set of actions.",
						Validators: []validator.String{
							stringvalidator.OneOf(
								"OK",
								"Failed",
					...
					"transaction_id": schema.Int64Attribute{
						...
						MarkdownDescription: "The transaction id these actions were part of.",
					},
				},
				...
				MarkdownDescription: "DeviationActionStatus defines the observed state of DeviationAction",
			},
		},
	}
}

type DeviationActionModel struct {
...
func (t ActionsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	recurseAttribute, ok := attributes["recurse"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`recurse is missing from object`)

		return nil, diags
	}

	recurseVal, ok := recurseAttribute.(basetypes.BoolValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`recurse expected to be basetypes.BoolValue, was: %T`, recurseAttribute))
	}
...
type ActionsValue struct {
	...
	Recurse basetypes.BoolValue   `tfsdk:"recurse"`
	state   attr.ValueState
}
...
func (v ActionsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["recurse"] = basetypes.BoolType{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.Recurse.ToTerraformValue(ctx)
...
func (v ActionsValue) Equal(o attr.Value) bool {
	...
	if !v.Recurse.Equal(other.Recurse) {
		return false
	}
...
func (t StatusType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	transactionIdAttribute, ok := attributes["transaction_id"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`transaction_id is missing from object`)

		return nil, diags
	}

	transactionIdVal, ok := transactionIdAttribute.(basetypes.Int64Value)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`transaction_id expected to be basetypes.Int64Value, was: %T`, transactionIdAttribute))
	}
...
type StatusValue struct {
	...
	TransactionId basetypes.Int64Value  `tfsdk:"transaction_id"`
	state         attr.ValueState
}
...
func (v StatusValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["transaction_id"] = basetypes.Int64Type{}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.TransactionId.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["transaction_id"] = val
...
func (v StatusValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	attributeTypes := map[string]attr.Type{
		...
		"transaction_id": basetypes.Int64Type{},
	}
...
func (v StatusValue) Equal(o attr.Value) bool {
	...
	if !v.TransactionId.Equal(other.TransactionId) {
		return false
	}
