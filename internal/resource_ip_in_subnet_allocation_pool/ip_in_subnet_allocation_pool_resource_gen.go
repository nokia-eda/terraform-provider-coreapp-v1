...
package resource_ip_in_subnet_allocation_pool
...
func IpInSubnetAllocationPoolResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^IPInSubnetAllocationPool$"), ""),
				},
				Default: stringdefault.StaticString("IPInSubnetAllocationPool"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the IPInSubnetAllocationPool",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
...
type IpInSubnetAllocationPoolModel struct {
