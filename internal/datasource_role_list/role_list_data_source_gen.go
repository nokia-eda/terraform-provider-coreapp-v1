...
func RoleListDataSourceSchema(ctx context.Context) schema.Schema {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"spec": schema.SingleNestedAttribute{
							Attributes: map[string]schema.Attribute{
								...
								"resource_rules": schema.ListNestedAttribute{
									...
									MarkdownDescription: "The rules for access to kubernetes resources",
								},
								"table_rules": schema.ListNestedAttribute{
									...
									MarkdownDescription: "The rules for access to the database tables.",
								},
								"url_rules": schema.ListNestedAttribute{
									...
									MarkdownDescription: "The rules for access to api-server proxied routes.",
								},
							},
							CustomType: SpecType{
								ObjectType: types.ObjectType{
							...
							MarkdownDescription: "RoleSpec defines the desired state of Role",
						},
						"status": schema.SingleNestedAttribute{
							...
							MarkdownDescription: "RoleStatus defines the observed state of Role",
						},
					},
