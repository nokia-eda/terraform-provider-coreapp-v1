...
package datasource_subnet_allocation_pool_list
...
func SubnetAllocationPoolListDataSourceSchema(ctx context.Context) schema.Schema {
...
type SubnetAllocationPoolListModel struct {
