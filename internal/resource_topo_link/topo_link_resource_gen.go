...
func TopoLinkResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TopoLink$"), ""),
				},
				Default: stringdefault.StaticString("TopoLink"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TopoLink",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
