...
package resource_topo_breakout
...
func TopoBreakoutResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^TopoBreakout$"), ""),
				},
				Default: stringdefault.StaticString("TopoBreakout"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the TopoBreakout",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "TopoBreakoutStatus defines the observed state of TopoBreakout",
			},
		},
	}
}

type TopoBreakoutModel struct {
