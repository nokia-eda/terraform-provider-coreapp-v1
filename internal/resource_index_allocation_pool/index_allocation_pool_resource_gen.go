...
package resource_index_allocation_pool
...
func IndexAllocationPoolResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^IndexAllocationPool$"), ""),
				},
				Default: stringdefault.StaticString("IndexAllocationPool"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the IndexAllocationPool",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "IndexAllocationPoolStatus defines the observed state of IndexAllocationPool",
			},
		},
	}
}

type IndexAllocationPoolModel struct {
