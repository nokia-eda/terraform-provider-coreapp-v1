...
package datasource_namespace_list
...
func NamespaceListDataSourceSchema(ctx context.Context) schema.Schema {
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"status": schema.SingleNestedAttribute{
							...
							MarkdownDescription: "NamespaceStatus defines the observed state of Namespace",
						},
					},
