...
package resource_subnet_allocation_pool
...
func SubnetAllocationPoolResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^SubnetAllocationPool$"), ""),
				},
				Default: stringdefault.StaticString("SubnetAllocationPool"),
			},
			...
			"name": schema.StringAttribute{
				...
				MarkdownDescription: "name of the SubnetAllocationPool",
			},
			"namespace": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
			...
			"status": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "SubnetAllocationPoolStatus defines the observed state of SubnetAllocationPool",
			},
		},
	}
}
